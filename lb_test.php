        ...
        <div id="page-wrapper">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <center><h1 class="page-head-line">Welcome </h1></center>
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    if ($result->num_rows > 0)
                                    {
                                        ...
                                        echo "<thead><tr><th>Patient Name</th><th>Age</th><th>Gender</th><th>Blood Group</th><th>Contact No.</th><th>Appointment Date</th></tr></thead><tbody id = 'test'>";
                                        while ($row = $result->fetch_assoc())
                                        {
                                            echo '<tr><td>' . $row['patient_name'] . '</td><td>' . $row['age'] . '</td><td>' . $row['gender'] . '</td><td>' . $row['blood'] . '</td><td>' . $row['mobile'] . '</td><td>' . $row['book_date'] . '</td><tr>';
                                        }
                                        echo "</tbody></table>";
                                    } else 
                                    {
